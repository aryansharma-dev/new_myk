...
const Footer = () => {
  return (
    <div>
        ...
        <div>
            ...
            <p className='w-full md:w-2/3 text-gray-600 dark:invert'>
        ...
        <div>
            <p className='text-xl font-medium mb-5 dark:invert'>COMPANY</p>
            <ul className='flex flex-col gap-1 text-gray-600 dark:invert'>
            <li>Home</li>
            <li>About us</li>
            <li>Delivery</li>
        ...
        <div>
            <p className='text-xl font-medium mb-5 dark:invert'>GET IN TOUCH</p>
           <ul className="flex flex-col gap-3 text-gray-600">
  <li className="flex items-center gap-2 dark:invert">
  ...
  <li className="flex items-center gap-2 ">
    <span>✉</span>
    <a href="mailto:help.tinymillion@gmail.com" className="hover:underline dark:invert">
...
<li className="flex items-center gap-2 dark:invert">
  ...
  <a href="https://pin.it/2FUh69ciP" target="_blank" rel="noopener noreferrer">
    Pinterest
            ...
            <div>
            <hr />
           <p className='py-5 text-sm text-center text-gray-500 dark:invert'>
