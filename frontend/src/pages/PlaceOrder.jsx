...
const PlaceOrder = () => {
  ...
  return (
    <form
      ...
      {/* ------------- Left Side ---------------- */}
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px] dark:invert">
        <div className="text-xl sm:text-2xl my-3 dark">
      ...
      <div className='mt-8'>
        ...
        <div className="mt-12 dark:invert">
          <Title text1={"PAYMENT"} text2={"METHOD"} />

          {!paymentsConfigured && (
            <div className="mt-3 rounded-md border border-yellow-300 bg-yellow-50 p-3 text-sm text-yellow-800 dark:invert">
        ...
        <div className="w-full text-end mt-8 ">
          <button
            type="submit"
            className={`bg-black text-white px-16 py-3 text-sm dark:bg-gray-900 text-black dark:text-white ${loading ? "opacity-60 cursor-not-allowed" : ""
              }`}
