...
const SubAdminLayout = () => {
  ...
  const navItems = [
    { path: '/subadmin/dashboard', icon: <Home className="w-5 h-5" />, label: 'Dashboard' },
    { path: '/subadmin/store-settings', icon: <Settings className="w-5 h-5" />, label: 'Store Settings' },
    { path: '/subadmin/products', icon: <Package className="w-5 h-5" />, label: 'Products' },
    { path: '/subadmin/orders', icon: <ShoppingBag className="w-5 h-5" />, label: 'Orders' },
    { path: '/subadmin/trending', icon: <TrendingUp className="w-5 h-5" />, label: 'Latest Collection' },
  ];
      ...
      <header className="bg-white border-b sticky top-0 z-40">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-gray-900">TinyMillion</h1>
          </div>
